...
var SiemHttpDestination = /*#__PURE__*/(0, _createClass2.default)(function SiemHttpDestination() {
  ...
  (0, _defineProperty2.default)(this, "getCrowdstrikeTokenMasked", function () {
    return _this.attributes.crowdstrike_token_masked;
  });
  (0, _defineProperty2.default)(this, "setCrowdstrikeTokenMasked", function (value) {
    _this.attributes.crowdstrike_token_masked = value;
  });
  ...
  // string # Applicable only for destination type: crowdstrike. Authentication token provided by Crowdstrike.
  (0, _defineProperty2.default)(this, "getCrowdstrikeToken", function () {
    return _this.attributes.crowdstrike_token;
  });
  (0, _defineProperty2.default)(this, "setCrowdstrikeToken", function (value) {
    _this.attributes.crowdstrike_token = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          if (!(params.crowdstrike_token && !(0, _utils.isString)(params.crowdstrike_token))) {
            _context.next = 10;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: crowdstrike_token must be of type String, received ".concat((0, _utils.getType)(params.crowdstrike_token)));
        case 10:
