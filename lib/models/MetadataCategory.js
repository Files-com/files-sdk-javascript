...
//   default_columns - array(string) - Metadata keys that should appear as columns in the UI by default.
(0, _defineProperty2.default)(MetadataCategory, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee6() {
  var params,
    options,
    response,
    _args6 = arguments;
  return _regenerator.default.wrap(function (_context6) {
    while (1) switch (_context6.prev = _context6.next) {
      ...
      case 4:
        ...
        return _context6.abrupt("return", new _MetadataCategory(response === null || response === void 0 ? void 0 : response.data, options));
      case 5:
      case "end":
