 ...
 * Class EventChannel
 */
var EventChannel = /*#__PURE__*/(0, _createClass2.default)(function EventChannel() {
  var _this = this;
  ...
  (0, _defineProperty2.default)(this, "getDefaultChannel", function () {
    return _this.attributes.default_channel;
  });
  (0, _defineProperty2.default)(this, "setDefaultChannel", function (value) {
    _this.attributes.default_channel = value;
  });
  ...
  (0, _defineProperty2.default)(this, "delete", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
    ...
    return _regenerator.default.wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          _context2.next = 6;
          return _Api.default.sendRequest("/event_channels/".concat(encodeURIComponent(params.id)), 'DELETE', params, _this.options);
        case 6:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "save", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          _context3.next = 3;
          return EventChannel.create(_this.attributes, _this.options);
        case 3:
...
(0, _defineProperty2.default)(EventChannel, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee4() {
  ...
  return _regenerator.default.wrap(function (_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      ...
      case 2:
        _context4.next = 3;
        return _Api.default.sendRequest('/event_channels', 'GET', params, options);
      case 3:
        response = _context4.sent;
        return _context4.abrupt("return", (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
          return new _EventChannel(obj, options);
        })) || []);
      case 4:
      case "end":
...
(0, _defineProperty2.default)(EventChannel, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _EventChannel.list(params, options);
});
// Parameters:
//   id (required) - int64 - Event Channel ID.
(0, _defineProperty2.default)(EventChannel, "find", /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee5(id) {
    ...
    return _regenerator.default.wrap(function (_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 4;
          return _Api.default.sendRequest("/event_channels/".concat(encodeURIComponent(params.id)), 'GET', params, options);
        case 4:
          response = _context5.sent;
          return _context5.abrupt("return", new _EventChannel(response === null || response === void 0 ? void 0 : response.data, options));
        case 5:
        case "end":
...
(0, _defineProperty2.default)(EventChannel, "get", function (id) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return _EventChannel.find(id, params, options);
});
// Parameters:
...
//   enabled - boolean - Whether this Event Channel can dispatch events.
//   default_channel - boolean - Whether this Event Channel is the default destination for newly published events.
(0, _defineProperty2.default)(EventChannel, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee6() {
  var params,
    options,
    response,
    _args6 = arguments;
...
var _default = exports.default = EventChannel;
