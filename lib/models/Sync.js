...
var Sync = /*#__PURE__*/(0, _createClass2.default)(function Sync() {
  ...
  (0, _defineProperty2.default)(this, "getSrcSiteId", function () {
    return _this.attributes.src_site_id;
  });
  (0, _defineProperty2.default)(this, "setSrcSiteId", function (value) {
    _this.attributes.src_site_id = value;
  });
  // int64 # Destination site ID if syncing to a child or partner site
  (0, _defineProperty2.default)(this, "getDestSiteId", function () {
    return _this.attributes.dest_site_id;
  });
  (0, _defineProperty2.default)(this, "setDestSiteId", function (value) {
    _this.attributes.dest_site_id = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          if (!(params.exclude_patterns && !(0, _utils.isArray)(params.exclude_patterns))) {
            _context3.next = 7;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: exclude_patterns must be of type Array, received ".concat((0, _utils.getType)(params.exclude_patterns)));
        case 7:
        ...
        case 8:
          if (!(params.include_patterns && !(0, _utils.isArray)(params.include_patterns))) {
            _context3.next = 9;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: include_patterns must be of type Array, received ".concat((0, _utils.getType)(params.include_patterns)));
        case 9:
