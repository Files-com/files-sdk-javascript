...
var PartnerSite = /*#__PURE__*/(0, _createClass2.default)(function PartnerSite() {
  ...
  (0, _defineProperty2.default)(this, "getHostPartnerName", function () {
    return _this.attributes.host_partner_name;
  });
  // int64 # Guest Partner ID
  (0, _defineProperty2.default)(this, "getGuestPartnerId", function () {
    return _this.attributes.guest_partner_id;
  });
  // string # Guest Partner Name
  (0, _defineProperty2.default)(this, "getGuestPartnerName", function () {
    return _this.attributes.guest_partner_name;
  });
  // int64 # Host Site ID
  (0, _defineProperty2.default)(this, "getHostSiteId", function () {
    return _this.attributes.host_site_id;
  });
  ...
  // int64 # Guest Site ID
  (0, _defineProperty2.default)(this, "getGuestSiteId", function () {
    return _this.attributes.guest_site_id;
  });
  // string # Guest Site Name
  (0, _defineProperty2.default)(this, "getGuestSiteName", function () {
    return _this.attributes.guest_site_name;
  });
