 ...
 * Class Schedule
 */
var Schedule = /*#__PURE__*/(0, _createClass2.default)(function Schedule() {
  var _this = this;
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          _context.next = 11;
          return _Api.default.sendRequest("/schedules/".concat(encodeURIComponent(params.id)), 'PATCH', params, _this.options);
        case 11:
          response = _context.sent;
          return _context.abrupt("return", new Schedule(response === null || response === void 0 ? void 0 : response.data, _this.options));
        case 12:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "delete", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
    ...
    return _regenerator.default.wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          _context2.next = 6;
          return _Api.default.sendRequest("/schedules/".concat(encodeURIComponent(params.id)), 'DELETE', params, _this.options);
        case 6:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "save", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          _context3.next = 3;
          return Schedule.create(_this.attributes, _this.options);
        case 3:
...
(0, _defineProperty2.default)(Schedule, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee4() {
  var _response$data;
  var params,
    options,
    response,
  ...
  return _regenerator.default.wrap(function (_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      ...
      case 2:
        _context4.next = 3;
        return _Api.default.sendRequest('/schedules', 'GET', params, options);
      case 3:
        response = _context4.sent;
        return _context4.abrupt("return", (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
          return new _Schedule(obj, options);
        })) || []);
      case 4:
      case "end":
...
(0, _defineProperty2.default)(Schedule, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _Schedule.list(params, options);
});
// Parameters:
//   id (required) - int64 - Schedule ID.
(0, _defineProperty2.default)(Schedule, "find", /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee5(id) {
    ...
    return _regenerator.default.wrap(function (_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 4;
          return _Api.default.sendRequest("/schedules/".concat(encodeURIComponent(params.id)), 'GET', params, options);
        case 4:
          response = _context5.sent;
          return _context5.abrupt("return", new _Schedule(response === null || response === void 0 ? void 0 : response.data, options));
        case 5:
        case "end":
...
(0, _defineProperty2.default)(Schedule, "get", function (id) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return _Schedule.find(id, params, options);
});
// Parameters:
...
//   schedule_time_zone - string - Time zone for scheduled times. If not set, times are interpreted as UTC.
//   holiday_region - string - Optional holiday region on which linked resources do not run.
(0, _defineProperty2.default)(Schedule, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee6() {
  var params,
    options,
    response,
    _args6 = arguments;
  return _regenerator.default.wrap(function (_context6) {
    while (1) switch (_context6.prev = _context6.next) {
      ...
      case 8:
        _context6.next = 9;
        return _Api.default.sendRequest('/schedules', 'POST', params, options);
      case 9:
        response = _context6.sent;
        return _context6.abrupt("return", new _Schedule(response === null || response === void 0 ? void 0 : response.data, options));
      case 10:
      case "end":
