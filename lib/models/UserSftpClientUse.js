...
// Parameters:
//   user_id - int64 - User ID.  Provide a value of `0` to operate the current session's user.
(0, _defineProperty2.default)(UserSftpClientUse, "createExport", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
  var _response$data2;
  var params,
    options,
    response,
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 4:
        _context2.next = 6;
        return _Api.default.sendRequest('/user_sftp_client_uses/create_export', 'POST', params, options);
      case 6:
