    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          throw new errors.InvalidParameterError("Bad parameter: action_notification_export_id must be of type Int, received ".concat((0, _utils.getType)(action_notification_export_id)));
