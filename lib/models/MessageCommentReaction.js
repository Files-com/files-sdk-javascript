...
_MessageCommentReaction = MessageCommentReaction;
// Parameters:
...
(0, _defineProperty2.default)(MessageCommentReaction, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _MessageCommentReaction.list(params, options);
});
// Parameters:
...
(0, _defineProperty2.default)(MessageCommentReaction, "get", function (id) {
  ...
  return _MessageCommentReaction.find(id, params, options);
});
// Parameters:
//   user_id - int64 - User ID.  Provide a value of `0` to operate the current session's user.
