...
(0, _defineProperty2.default)(Priority, "all", function (path) {
  ...
  return _Priority.list(path, params, options);
});
// Parameters:
//   path (required) - string - The path to query for priorities
(0, _defineProperty2.default)(Priority, "createExport", /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2(path) {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          _context2.next = 11;
          return _Api.default.sendRequest('/priorities/create_export', 'POST', params, options);
        case 11:
