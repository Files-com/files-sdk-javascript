...
var RemoteServer = function RemoteServer() {
  ...
  (0, _defineProperty2.default)(this, "getSharepointHostname", function () {
    return _this.attributes.sharepoint_hostname;
  });
  (0, _defineProperty2.default)(this, "setSharepointHostname", function (value) {
    _this.attributes.sharepoint_hostname = value;
  });
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 74:
            if (!(params['sharepoint_hostname'] && !(0, _utils.isString)(params['sharepoint_hostname']))) {
              _context.next = 76;
              break;
            }

            throw new Error("Bad parameter: sharepoint_hostname must be of type String, received ".concat((0, _utils.getType)(sharepoint_hostname)));
