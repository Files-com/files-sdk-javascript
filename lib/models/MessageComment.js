 ...
 */
var MessageComment = function MessageComment() {
  var _this = this;

  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, MessageComment);
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 22:
            return _context.abrupt("return", _Api.default.sendRequest("/message_comments/' . params['id'] . '", 'PATCH', params, _this.options));
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 14:
            return _context2.abrupt("return", _Api.default.sendRequest("/message_comments/' . params['id'] . '", 'DELETE', params, _this.options));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 14:
          ...
          throw new Error("Bad parameter: message_id must be of type Int, received ".concat((0, _utils.getType)(message_id)));
    ...
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            _context4.next = 11;
            return _Api.default.sendRequest("/message_comments/' . params['id'] . '", 'GET', params, options);

          case 11:
            response = _context4.sent;
            return _context4.abrupt("return", new MessageComment(response === null || response === void 0 ? void 0 : response.data, options));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          return _context5.abrupt("return", new MessageComment(response === null || response === void 0 ? void 0 : response.data, options));
