...
class PendingWorkEvent {
  ...
  static list = async (params = {}, options = {}) => {
    ...
    const response = await Api.sendRequest('/pending_work_events', 'GET', params, options)

    return response?.data?.map(obj => new PendingWorkEvent(obj, options)) || []
  }

  static all = (params = {}, options = {}) =>
    PendingWorkEvent.list(params, options)
  ...
  static find = async (id, params = {}, options = {}) => {
    ...
    const response = await Api.sendRequest(`/pending_work_events/${encodeURIComponent(params.id)}`, 'GET', params, options)

    return new PendingWorkEvent(response?.data, options)
  }

  static get = (id, params = {}, options = {}) =>
    PendingWorkEvent.find(id, params, options)
}

export default PendingWorkEvent
