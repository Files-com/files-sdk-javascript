  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          if (!(params.dest_site_id && !(0, _utils.isInt)(params.dest_site_id))) {
            _context3.next = 7;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: dest_site_id must be of type Int, received ".concat((0, _utils.getType)(params.dest_site_id)));
        case 7:
        ...
        case 18:
          if (!(params.src_site_id && !(0, _utils.isInt)(params.src_site_id))) {
            _context3.next = 19;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: src_site_id must be of type Int, received ".concat((0, _utils.getType)(params.src_site_id)));
        case 19:
