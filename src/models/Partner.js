...
class Partner {
  ...
  getShowPartnerChannelHomePage = () => this.attributes.show_partner_channel_home_page

  setShowPartnerChannelHomePage = value => {
    this.attributes.show_partner_channel_home_page = value
  }
