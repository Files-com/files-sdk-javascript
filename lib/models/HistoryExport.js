...
var HistoryExport = function HistoryExport() {
  ...
  (0, _defineProperty2.default)(this, "getExportAs", function () {
    return _this.attributes.export_as;
  });
  (0, _defineProperty2.default)(this, "setExportAs", function (value) {
    _this.attributes.export_as = value;
  });
  (0, _defineProperty2.default)(this, "getFileExport", function () {
    return _this.attributes.file_export;
  });
  (0, _defineProperty2.default)(this, "setFileExport", function (value) {
    _this.attributes.file_export = value;
  });
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 8:
          if (!(params['export_as'] && !(0, _utils.isString)(params['export_as']))) {
            _context2.next = 10;
            break;
          }

          throw new Error("Bad parameter: export_as must be of type String, received ".concat((0, _utils.getType)(export_as)));
