 ...
 * Class CustomDomain
 */
var CustomDomain = /*#__PURE__*/(0, _createClass2.default)(function CustomDomain() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, CustomDomain);
  ...
  (0, _defineProperty2.default)(this, "getDnsStatus", function () {
    return _this.attributes.dns_status;
  });
  (0, _defineProperty2.default)(this, "setDnsStatus", function (value) {
    _this.attributes.dns_status = value;
  });
  // int64 # Current SSL certificate ID.
  (0, _defineProperty2.default)(this, "getSslCertificateId", function () {
    return _this.attributes.ssl_certificate_id;
  });
  (0, _defineProperty2.default)(this, "setSslCertificateId", function (value) {
    _this.attributes.ssl_certificate_id = value;
  });
  // boolean # Is this domain's SSL certificate automatically managed and renewed by Files.com?
  (0, _defineProperty2.default)(this, "getBrickManaged", function () {
    return _this.attributes.brick_managed;
  });
  (0, _defineProperty2.default)(this, "setBrickManaged", function (value) {
    _this.attributes.brick_managed = value;
  });
  ...
  (0, _defineProperty2.default)(this, "setIpAddresses", function (value) {
    _this.attributes.ip_addresses = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          if (!(params.ssl_certificate_id && !(0, _utils.isInt)(params.ssl_certificate_id))) {
            _context.next = 6;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: ssl_certificate_id must be of type Int, received ".concat((0, _utils.getType)(params.ssl_certificate_id)));
        case 6:
        ...
        case 9:
          _context.next = 10;
          return _Api.default.sendRequest("/custom_domains/".concat(encodeURIComponent(params.id)), 'PATCH', params, _this.options);
        case 10:
          response = _context.sent;
          return _context.abrupt("return", new CustomDomain(response === null || response === void 0 ? void 0 : response.data, _this.options));
        case 11:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "delete", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
    ...
    return _regenerator.default.wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          _context2.next = 6;
          return _Api.default.sendRequest("/custom_domains/".concat(encodeURIComponent(params.id)), 'DELETE', params, _this.options);
        case 6:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "save", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          _context3.next = 3;
          return CustomDomain.create(_this.attributes, _this.options);
        case 3:
...
(0, _defineProperty2.default)(CustomDomain, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee4() {
  var _response$data;
  var params,
    options,
    response,
  ...
  return _regenerator.default.wrap(function (_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      ...
      case 2:
        _context4.next = 3;
        return _Api.default.sendRequest('/custom_domains', 'GET', params, options);
      case 3:
        response = _context4.sent;
        return _context4.abrupt("return", (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
          return new _CustomDomain(obj, options);
        })) || []);
      case 4:
      case "end":
...
(0, _defineProperty2.default)(CustomDomain, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _CustomDomain.list(params, options);
});
// Parameters:
//   id (required) - int64 - Custom Domain ID.
(0, _defineProperty2.default)(CustomDomain, "find", /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee5(id) {
    ...
    return _regenerator.default.wrap(function (_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 4;
          return _Api.default.sendRequest("/custom_domains/".concat(encodeURIComponent(params.id)), 'GET', params, options);
        case 4:
          response = _context5.sent;
          return _context5.abrupt("return", new _CustomDomain(response === null || response === void 0 ? void 0 : response.data, options));
        case 5:
        case "end":
...
(0, _defineProperty2.default)(CustomDomain, "get", function (id) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return _CustomDomain.find(id, params, options);
});
// Parameters:
//   id (required) - int64 - Custom Domain ID.
//   count (required) - int64 - Number of dedicated IP addresses to allocate.
(0, _defineProperty2.default)(CustomDomain, "createAllocateIp", /*#__PURE__*/function () {
    ...
    return _regenerator.default.wrap(function (_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          throw new errors.InvalidParameterError("Bad parameter: id must be of type Int, received ".concat((0, _utils.getType)(params.id)));
        case 4:
          if (!(params.count && !(0, _utils.isInt)(params.count))) {
            _context6.next = 5;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: count must be of type Int, received ".concat((0, _utils.getType)(params.count)));
        case 5:
          _context6.next = 6;
          return _Api.default.sendRequest("/custom_domains/".concat(encodeURIComponent(params.id), "/allocate_ips"), 'POST', params, options);
        case 6:
          response = _context6.sent;
          return _context6.abrupt("return", new _CustomDomain(response === null || response === void 0 ? void 0 : response.data, options));
        case 7:
        case "end":
...
(0, _defineProperty2.default)(CustomDomain, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee7() {
  var params,
    options,
    response,
    _args7 = arguments;
  return _regenerator.default.wrap(function (_context7) {
    while (1) switch (_context7.prev = _context7.next) {
      ...
      case 5:
        _context7.next = 6;
        return _Api.default.sendRequest('/custom_domains', 'POST', params, options);
      case 6:
        response = _context7.sent;
        return _context7.abrupt("return", new _CustomDomain(response === null || response === void 0 ? void 0 : response.data, options));
      case 7:
      case "end":
...
var _default = exports.default = CustomDomain;
