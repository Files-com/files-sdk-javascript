    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          throw new Error("Bad parameter: raw_body must be of type String, received ".concat((0, _utils.getType)(raw_body)));
        ...
        case 12:
          ...
          throw new Error("Bad parameter: file_form_field must be of type String, received ".concat((0, _utils.getType)(file_form_field)));
