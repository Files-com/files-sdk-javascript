 ...
 */
var KeyLifecycleRule = /*#__PURE__*/(0, _createClass2.default)(function KeyLifecycleRule() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, KeyLifecycleRule);
  ...
  (0, _defineProperty2.default)(this, "getKeyType", function () {
    return _this.attributes.key_type;
  });
  (0, _defineProperty2.default)(this, "setKeyType", function (value) {
    _this.attributes.key_type = value;
  });
  ...
  (0, _defineProperty2.default)(this, "delete", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
    ...
    return _regenerator.default.wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          _context2.next = 6;
          return _Api.default.sendRequest("/key_lifecycle_rules/".concat(encodeURIComponent(params.id)), 'DELETE', params, _this.options);
        case 6:
        case "end":
  ...
  (0, _defineProperty2.default)(this, "save", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3() {
    ...
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          _context3.next = 3;
          return KeyLifecycleRule.create(_this.attributes, _this.options);
        case 3:
...
_KeyLifecycleRule = KeyLifecycleRule;
// Parameters:
...
(0, _defineProperty2.default)(KeyLifecycleRule, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee4() {
  ...
  return _regenerator.default.wrap(function (_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      ...
      case 2:
        _context4.next = 3;
        return _Api.default.sendRequest('/key_lifecycle_rules', 'GET', params, options);
      case 3:
        response = _context4.sent;
        return _context4.abrupt("return", (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
          return new _KeyLifecycleRule(obj, options);
        })) || []);
      case 4:
      case "end":
...
(0, _defineProperty2.default)(KeyLifecycleRule, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _KeyLifecycleRule.list(params, options);
});
// Parameters:
//   id (required) - int64 - Key Lifecycle Rule ID.
(0, _defineProperty2.default)(KeyLifecycleRule, "find", /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee5(id) {
    ...
    return _regenerator.default.wrap(function (_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 4;
          return _Api.default.sendRequest("/key_lifecycle_rules/".concat(encodeURIComponent(params.id)), 'GET', params, options);
        case 4:
          response = _context5.sent;
          return _context5.abrupt("return", new _KeyLifecycleRule(response === null || response === void 0 ? void 0 : response.data, options));
        case 5:
        case "end":
...
(0, _defineProperty2.default)(KeyLifecycleRule, "get", function (id) {
...
var _default = exports.default = KeyLifecycleRule;
