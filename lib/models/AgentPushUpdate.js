 ...
 */
var AgentPushUpdate = /*#__PURE__*/(0, _createClass2.default)(function AgentPushUpdate() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, AgentPushUpdate);
  ...
  (0, _defineProperty2.default)(this, "getCurrentVersion", function () {
    return _this.attributes.current_version;
  });
  // string # Pending agent version or null
  (0, _defineProperty2.default)(this, "getPendingVersion", function () {
    return _this.attributes.pending_version;
  });
  // string # Last error message or null
  (0, _defineProperty2.default)(this, "getLastError", function () {
    return _this.attributes.last_error;
  });
  // string # Error code
  (0, _defineProperty2.default)(this, "getError", function () {
    return _this.attributes.error;
  });
...
var _default = exports.default = AgentPushUpdate;
