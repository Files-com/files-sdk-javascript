...
var User = /*#__PURE__*/(0, _createClass2.default)(function User() {
  ...
  (0, _defineProperty2.default)(this, "getAiAssistantPersonalityId", function () {
    return _this.attributes.ai_assistant_personality_id;
  });
  (0, _defineProperty2.default)(this, "setAiAssistantPersonalityId", function (value) {
    _this.attributes.ai_assistant_personality_id = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getIntegrationCentricProfileId", function () {
    return _this.attributes.integration_centric_profile_id;
  });
  (0, _defineProperty2.default)(this, "setIntegrationCentricProfileId", function (value) {
    _this.attributes.integration_centric_profile_id = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getPartnerAdmin", function () {
    return _this.attributes.partner_admin;
  });
  (0, _defineProperty2.default)(this, "setPartnerAdmin", function (value) {
    _this.attributes.partner_admin = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getPrimaryGroupId", function () {
    return _this.attributes.primary_group_id;
  });
  (0, _defineProperty2.default)(this, "setPrimaryGroupId", function (value) {
    _this.attributes.primary_group_id = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getNotifyOnAllSiteWarnings", function () {
    return _this.attributes.notify_on_all_site_warnings;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllSiteWarnings", function (value) {
    _this.attributes.notify_on_all_site_warnings = value;
  });
  // boolean # Should the user receive sso/scim/ldap configuration/sync failures via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllSsoFailures", function () {
    return _this.attributes.notify_on_all_sso_failures;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllSsoFailures", function (value) {
    _this.attributes.notify_on_all_sso_failures = value;
  });
  // boolean # Should the user receive user security events via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllUserSecurityEvents", function () {
    return _this.attributes.notify_on_all_user_security_events;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllUserSecurityEvents", function (value) {
    _this.attributes.notify_on_all_user_security_events = value;
  });
  // boolean # Should the user receive pending work failures via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllPendingWorkFailures", function () {
    return _this.attributes.notify_on_all_pending_work_failures;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllPendingWorkFailures", function (value) {
    _this.attributes.notify_on_all_pending_work_failures = value;
  });
  // boolean # Should the user receive siem failures via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllSiemHttpDestinationFailures", function () {
    return _this.attributes.notify_on_all_siem_http_destination_failures;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllSiemHttpDestinationFailures", function (value) {
    _this.attributes.notify_on_all_siem_http_destination_failures = value;
  });
  // boolean # Should the user receive sync failures via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllSyncFailures", function () {
    return _this.attributes.notify_on_all_sync_failures;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllSyncFailures", function (value) {
    _this.attributes.notify_on_all_sync_failures = value;
  });
  // boolean # Should the user receive automation failures via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllAutomationFailures", function () {
    return _this.attributes.notify_on_all_automation_failures;
  });
  (0, _defineProperty2.default)(this, "setNotifyOnAllAutomationFailures", function (value) {
    _this.attributes.notify_on_all_automation_failures = value;
  });
  // boolean # Should the user receive expectation failures and misses via email?
  (0, _defineProperty2.default)(this, "getNotifyOnAllExpectationFailures", function () {
    return _this.attributes.notify_on_all_expectation_failures;
  });
  ...
  (0, _defineProperty2.default)(this, "getS3CompatibleEndpointPermission", function () {
    return _this.attributes.s3_compatible_endpoint_permission;
  });
  (0, _defineProperty2.default)(this, "setS3CompatibleEndpointPermission", function (value) {
    _this.attributes.s3_compatible_endpoint_permission = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getDefaultWorkspaceId", function () {
    return _this.attributes.default_workspace_id;
  });
  (0, _defineProperty2.default)(this, "setDefaultWorkspaceId", function (value) {
    _this.attributes.default_workspace_id = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee4() {
    ...
    return _regenerator.default.wrap(function (_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 12:
          if (!(params.ai_assistant_personality_id && !(0, _utils.isInt)(params.ai_assistant_personality_id))) {
            _context4.next = 13;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: ai_assistant_personality_id must be of type Int, received ".concat((0, _utils.getType)(params.ai_assistant_personality_id)));
        case 13:
        ...
        case 17:
          if (!(params.default_workspace_id && !(0, _utils.isInt)(params.default_workspace_id))) {
            _context4.next = 18;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: default_workspace_id must be of type Int, received ".concat((0, _utils.getType)(params.default_workspace_id)));
        case 18:
        ...
        case 20:
          if (!(params.integration_centric_profile_id && !(0, _utils.isInt)(params.integration_centric_profile_id))) {
            _context4.next = 21;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: integration_centric_profile_id must be of type Int, received ".concat((0, _utils.getType)(params.integration_centric_profile_id)));
        case 21:
        ...
        case 28:
          if (!(params.primary_group_id && !(0, _utils.isInt)(params.primary_group_id))) {
            _context4.next = 29;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: primary_group_id must be of type Int, received ".concat((0, _utils.getType)(params.primary_group_id)));
        case 29:
