    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 20:
            return _context.abrupt("return", _Api.default.sendRequest("/styles/".concat(encodeURIComponent(params['path'])), 'PATCH', params, _this.options));
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 14:
            return _context2.abrupt("return", _Api.default.sendRequest("/styles/".concat(encodeURIComponent(params['path'])), 'DELETE', params, _this.options));
...
(0, _defineProperty2.default)(Style, "list", /*#__PURE__*/function () {
...
(0, _defineProperty2.default)(Style, "all", function (path) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return Style.list(path, params, options);
});
var _default = Style;
