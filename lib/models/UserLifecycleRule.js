...
var UserLifecycleRule = /*#__PURE__*/(0, _createClass2.default)(function UserLifecycleRule() {
  ...
  (0, _defineProperty2.default)(this, "getNotifyUsers", function () {
    return _this.attributes.notify_users;
  });
  (0, _defineProperty2.default)(this, "setNotifyUsers", function (value) {
    _this.attributes.notify_users = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          if (!(params.group_ids && !(0, _utils.isArray)(params.group_ids))) {
            _context.next = 6;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: group_ids must be of type Array, received ".concat((0, _utils.getType)(params.group_ids)));
        case 6:
