...
//   include_parent_site_users - boolean - Include users from the parent site.
//   search - string - Searches for partial matches of name, username, or email.
(0, _defineProperty2.default)(User, "createExport", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee10() {
  var _response$data2;
  var params,
    options,
    response,
  ...
  return _regenerator.default.wrap(function _callee10$(_context10) {
    while (1) switch (_context10.prev = _context10.next) {
      ...
      case 6:
        _context10.next = 8;
        return _Api.default.sendRequest('/users/create_export', 'POST', params, options);
      case 8:
        response = _context10.sent;
        Export = require('./Export.js').default;
        return _context10.abrupt("return", (response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.map(function (obj) {
