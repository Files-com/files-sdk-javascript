...
var RemoteServer = /*#__PURE__*/(0, _createClass2.default)(function RemoteServer() {
  ...
  (0, _defineProperty2.default)(this, "getAzureFilesSasToken", function () {
    return _this.attributes.azure_files_sas_token;
  });
  (0, _defineProperty2.default)(this, "setAzureFilesSasToken", function (value) {
    _this.attributes.azure_files_sas_token = value;
  });
  (0, _defineProperty2.default)(this, "getAzureFilesShareName", function () {
    return _this.attributes.azure_files_share_name;
  });
  (0, _defineProperty2.default)(this, "setAzureFilesShareName", function (value) {
    _this.attributes.azure_files_share_name = value;
  });
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 84:
            if (!(params['azure_files_share_name'] && !(0, _utils.isString)(params['azure_files_share_name']))) {
              _context.next = 86;
              break;
            }

            throw new Error("Bad parameter: azure_files_share_name must be of type String, received ".concat((0, _utils.getType)(azure_files_share_name)));

          case 86:
            if (!(params['azure_files_sas_token'] && !(0, _utils.isString)(params['azure_files_sas_token']))) {
              _context.next = 88;
              break;
            }

            throw new Error("Bad parameter: azure_files_sas_token must be of type String, received ".concat((0, _utils.getType)(azure_files_sas_token)));
