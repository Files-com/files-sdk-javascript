...
class UserSecurityEvent {
  ...
  static list = async (params = {}, options = {}) => {
    ...
    const response = await Api.sendRequest('/user_security_events', 'GET', params, options)

    return response?.data?.map(obj => new UserSecurityEvent(obj, options)) || []
  }

  static all = (params = {}, options = {}) =>
    UserSecurityEvent.list(params, options)
  ...
  static find = async (id, params = {}, options = {}) => {
    ...
    const response = await Api.sendRequest(`/user_security_events/${encodeURIComponent(params.id)}`, 'GET', params, options)

    return new UserSecurityEvent(response?.data, options)
  }

  static get = (id, params = {}, options = {}) =>
    UserSecurityEvent.find(id, params, options)
}

export default UserSecurityEvent
