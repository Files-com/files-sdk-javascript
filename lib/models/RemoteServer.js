...
(0, _defineProperty2.default)(RemoteServer, "listForTesting", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
  var params,
      options,
      response,
      _args5 = arguments;
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          throw new Error("Bad parameter: remote_server_id must be of type Int, received ".concat((0, _utils.getType)(remote_server_id)));
        ...
        case 4:
          ...
          throw new Error("Bad parameter: root must be of type String, received ".concat((0, _utils.getType)(root)));
        ...
        case 76:
          _context5.next = 78;
          return _Api.default.sendRequest("/remote_servers/list_for_testing", 'GET', params, options);

        case 78:
          response = _context5.sent;
          return _context5.abrupt("return", new File(response === null || response === void 0 ? void 0 : response.data, options));
...
(0, _defineProperty2.default)(RemoteServer, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
  var params,
      options,
      response,
      _args6 = arguments;
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 74:
          ...
          return _context6.abrupt("return", new RemoteServer(response === null || response === void 0 ? void 0 : response.data, options));
