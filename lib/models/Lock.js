...
var Lock = function Lock() {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 22:
            return _context.abrupt("return", _Api.default.sendRequest("/locks/".concat(encodeURIComponent(params['path'])), 'DELETE', params, _this.options));
  ...
  (0, _defineProperty2.default)(this, "save", function () {
    if (_this.attributes['path']) {
      ...
      var newObject = Lock.create(_this.attributes, _this.options);
