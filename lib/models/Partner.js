...
var Partner = /*#__PURE__*/(0, _createClass2.default)(function Partner() {
  ...
  (0, _defineProperty2.default)(this, "setConnections", function (value) {
    _this.attributes.connections = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getPartnershipRole", function () {
    return _this.attributes.partnership_role;
  });
  (0, _defineProperty2.default)(this, "setPartnershipRole", function (value) {
    _this.attributes.partnership_role = value;
  });
  ...
  (0, _defineProperty2.default)(this, "getShowPartnerChannelHomePage", function () {
    return _this.attributes.show_partner_channel_home_page;
  });
  (0, _defineProperty2.default)(this, "setShowPartnerChannelHomePage", function (value) {
    _this.attributes.show_partner_channel_home_page = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          if (!(params.partner_channel_template_id && !(0, _utils.isInt)(params.partner_channel_template_id))) {
            _context.next = 7;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: partner_channel_template_id must be of type Int, received ".concat((0, _utils.getType)(params.partner_channel_template_id)));
        case 7:
        ...
        case 11:
          if (!(params.partnership_role && !(0, _utils.isString)(params.partnership_role))) {
            _context.next = 12;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: partnership_role must be of type String, received ".concat((0, _utils.getType)(params.partnership_role)));
        case 12:
