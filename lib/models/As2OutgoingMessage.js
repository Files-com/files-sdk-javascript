...
//   filter_lteq - object - If set, return records where the specified field is less than or equal the supplied value. Valid fields are `created_at`.
//   as2_partner_id - int64 - As2 Partner ID.  If provided, will return message specific to that partner.
(0, _defineProperty2.default)(As2OutgoingMessage, "createExport", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
  var params,
    options,
    response,
    Export,
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 4:
        _context2.next = 6;
        return _Api.default.sendRequest('/as2_outgoing_messages/create_export', 'POST', params, options);
      case 6:
