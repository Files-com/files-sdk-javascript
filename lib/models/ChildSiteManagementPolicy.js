...
var ChildSiteManagementPolicy = /*#__PURE__*/(0, _createClass2.default)(function ChildSiteManagementPolicy() {
  ...
  (0, _defineProperty2.default)(this, "getChildSiteIds", function () {
    return _this.attributes.child_site_ids;
  });
  (0, _defineProperty2.default)(this, "setChildSiteIds", function (value) {
    _this.attributes.child_site_ids = value;
  });
  // boolean # Whether this policy applies to child sites not explicitly assigned to another policy.
  (0, _defineProperty2.default)(this, "getDefaultPolicy", function () {
    return _this.attributes.default_policy;
  });
  (0, _defineProperty2.default)(this, "setDefaultPolicy", function (value) {
    _this.attributes.default_policy = value;
  });
  ...
  (0, _defineProperty2.default)(this, "update", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    return _regenerator.default.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          if (!(params.child_site_ids && !(0, _utils.isArray)(params.child_site_ids))) {
            _context.next = 5;
            break;
          }
          throw new errors.InvalidParameterError("Bad parameter: child_site_ids must be of type Array, received ".concat((0, _utils.getType)(params.child_site_ids)));
        case 5:
