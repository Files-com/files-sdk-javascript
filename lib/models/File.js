      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 6:
            ...
            return _context9.abrupt("return", new _FileUploadPart.default(partData));
...
(0, _defineProperty2.default)(File, "_continueUpload", /*#__PURE__*/function () {
  var _ref12 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee10(path, partNumber, firstFileUploadPart) {
    var params, response, partData;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 6:
            ...
            return _context10.abrupt("return", new _FileUploadPart.default(partData));
...
(0, _defineProperty2.default)(File, "_completeUpload", /*#__PURE__*/function () {
  var _ref13 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee11(fileUploadPart) {
    var params;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt("return", _Api.default.sendRequest("/files/".concat(encodeURIComponent(fileUploadPart.path)), 'POST', params));
    ...
    return _regenerator.default.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 2:
            fileUploadPart = _context14.sent;
                  ...
                  return _regenerator.default.wrap(function _callee12$(_context12) {
                    while (1) {
                      switch (_context12.prev = _context12.next) {
                        ...
                        case 6:
                          nextFileUploadPart = _context12.sent;
                          _context12.next = 9;
                ...
                return _regenerator.default.wrap(function _callee13$(_context13) {
                  while (1) {
                    switch (_context13.prev = _context13.next) {
                      ...
                      case 4:
                        nextFileUploadPart = _context13.sent;
                        _context13.next = 7;
                        return _Api.default.sendFilePart(nextFileUploadPart.upload_uri, 'PUT', buffer);
