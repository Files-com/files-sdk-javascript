 ...
 */
var SettingsChange = /*#__PURE__*/(0, _createClass2.default)(function SettingsChange() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, SettingsChange);
...
(0, _defineProperty2.default)(SettingsChange, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return SettingsChange.list(params, options);
});
var _default = SettingsChange;
