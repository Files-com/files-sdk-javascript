    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          throw new errors.InvalidParameterError("Bad parameter: query_message must be of type String, received ".concat((0, _utils.getType)(query_message)));
        ...
        case 10:
          ...
          throw new errors.InvalidParameterError("Bad parameter: query_request_method must be of type String, received ".concat((0, _utils.getType)(query_request_method)));
        ...
        case 12:
          ...
          throw new errors.InvalidParameterError("Bad parameter: query_request_url must be of type String, received ".concat((0, _utils.getType)(query_request_url)));
        ...
        case 14:
          ...
          throw new errors.InvalidParameterError("Bad parameter: query_status must be of type String, received ".concat((0, _utils.getType)(query_status)));
