 ...
 * Class FormFieldSet
 */
var FormFieldSet = function FormFieldSet() {
  var _this = this;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            throw new Error("Bad parameter: title must be of type String, received ".concat((0, _utils.getType)(title)));
          ...
          case 10:
            ...
            throw new Error("Bad parameter: form_fields must be of type Array, received ".concat((0, _utils.getType)(form_fields)));
          ...
          case 18:
            return _context.abrupt("return", _Api.default.sendRequest("/form_field_sets/".concat(params['id']), 'PATCH', params, _this.options));
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 14:
            return _context2.abrupt("return", _Api.default.sendRequest("/form_field_sets/".concat(params['id']), 'DELETE', params, _this.options));
  ...
  (0, _defineProperty2.default)(this, "save", function () {
    if (_this.attributes['id']) {
      ...
      var newObject = FormFieldSet.create(_this.attributes, _this.options);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 11:
            ...
            return _context4.abrupt("return", new FormFieldSet(response === null || response === void 0 ? void 0 : response.data, options));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          return _context5.abrupt("return", new FormFieldSet(response === null || response === void 0 ? void 0 : response.data, options));
