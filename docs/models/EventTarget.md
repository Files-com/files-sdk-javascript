...
```
const event_target = await EventTarget.find(id)

await event_target.update({
  'name': "example",
  'workspace_id': 1,
  'apply_to_all_workspaces': true,
  'target_type': "example",
