 ...
 */
var DirectConnectionInfo = /*#__PURE__*/(0, _createClass2.default)(function DirectConnectionInfo() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, DirectConnectionInfo);
  ...
  (0, _defineProperty2.default)(this, "getAddresses", function () {
    return _this.attributes.addresses;
  });
  // string # Signed HTTPS URI for direct Agent transfer traffic.
  (0, _defineProperty2.default)(this, "getDirectUri", function () {
    return _this.attributes.direct_uri;
  });
  // string # PEM-encoded CA certificate used to verify the Agent's direct transfer TLS certificate.
  (0, _defineProperty2.default)(this, "getCaPem", function () {
    return _this.attributes.ca_pem;
  });
...
var _default = exports.default = DirectConnectionInfo;
