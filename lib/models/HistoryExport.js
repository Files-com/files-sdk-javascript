    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            return _context.abrupt("return", _Api.default.sendRequest("/history_exports/' . params['id'] . '", 'DELETE', params, _this.options));
...
(0, _defineProperty2.default)(HistoryExport, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
  var _response$data;
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          _context2.next = 12;
          return _Api.default.sendRequest("/history_exports", 'GET', params, options);
        ...
        case 12:
          ...
          return _context2.abrupt("return", (response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
            return new HistoryExport(obj, options);
          })) || []);
...
(0, _defineProperty2.default)(HistoryExport, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return HistoryExport.list(params, options);
});
    ...
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            _context3.next = 11;
            return _Api.default.sendRequest("/history_exports/' . params['id'] . '", 'GET', params, options);

          case 11:
            response = _context3.sent;
            return _context3.abrupt("return", new HistoryExport(response === null || response === void 0 ? void 0 : response.data, options));
...
(0, _defineProperty2.default)(HistoryExport, "create", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
  var params,
      options,
      response,
      _args4 = arguments;
  return _regenerator.default.wrap(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 12:
          if (!(params['query_user_id'] && !(0, _utils.isInt)(params['query_user_id']))) {
            _context4.next = 14;
            break;
          }

          throw new Error("Bad parameter: query_user_id must be of type Int, received ".concat((0, _utils.getType)(query_user_id)));

        case 14:
          if (!(params['query_file_id'] && !(0, _utils.isInt)(params['query_file_id']))) {
            _context4.next = 16;
            break;
          }

          throw new Error("Bad parameter: query_file_id must be of type Int, received ".concat((0, _utils.getType)(query_file_id)));

        case 16:
          if (!(params['query_parent_id'] && !(0, _utils.isInt)(params['query_parent_id']))) {
            _context4.next = 18;
            break;
          }

          throw new Error("Bad parameter: query_parent_id must be of type Int, received ".concat((0, _utils.getType)(query_parent_id)));
        ...
        case 32:
          if (!(params['query_target_id'] && !(0, _utils.isInt)(params['query_target_id']))) {
            _context4.next = 34;
            break;
          }

          throw new Error("Bad parameter: query_target_id must be of type Int, received ".concat((0, _utils.getType)(query_target_id)));
        ...
        case 38:
          if (!(params['query_target_user_id'] && !(0, _utils.isInt)(params['query_target_user_id']))) {
            _context4.next = 40;
            break;
          }

          throw new Error("Bad parameter: query_target_user_id must be of type Int, received ".concat((0, _utils.getType)(query_target_user_id)));
        ...
        case 48:
          ...
          return _context4.abrupt("return", new HistoryExport(response === null || response === void 0 ? void 0 : response.data, options));
