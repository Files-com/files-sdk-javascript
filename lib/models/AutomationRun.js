 ...
 * Class AutomationRun
 */
var AutomationRun = function AutomationRun() {
  var _this = this;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          throw new Error("Bad parameter: automation_id must be of type Int, received ".concat((0, _utils.getType)(automation_id)));
