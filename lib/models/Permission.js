...
//   group_id - string
//   user_id - string
(0, _defineProperty2.default)(Permission, "createExport", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee5() {
  var params,
    options,
    response,
    Export,
  ...
  return _regenerator.default.wrap(function _callee5$(_context5) {
    while (1) switch (_context5.prev = _context5.next) {
      ...
      case 8:
        _context5.next = 10;
        return _Api.default.sendRequest('/permissions/create_export', 'POST', params, options);
      case 10:
