 ...
 * Class InboxUpload
 */
var InboxUpload = /*#__PURE__*/(0, _createClass2.default)(function InboxUpload() {
  var _this = this;

  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, InboxUpload);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          throw new Error("Bad parameter: inbox_registration_id must be of type Int, received ".concat((0, _utils.getType)(inbox_registration_id)));
...
(0, _defineProperty2.default)(InboxUpload, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return InboxUpload.list(params, options);
});
var _default = InboxUpload;
