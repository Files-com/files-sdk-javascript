    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            return _context.abrupt("return", _Api.default.sendRequest("/message_comment_reactions/' . params['id'] . '", 'DELETE', params, _this.options));
    ...
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            _context3.next = 11;
            return _Api.default.sendRequest("/message_comment_reactions/' . params['id'] . '", 'GET', params, options);
