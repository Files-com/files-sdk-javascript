 ...
 * Class SsoEvent
 */
var SsoEvent = /*#__PURE__*/(0, _createClass2.default)(function SsoEvent() {
  var _this = this;
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  (0, _classCallCheck2.default)(this, SsoEvent);
  ...
  (0, _defineProperty2.default)(this, "getIdpUid", function () {
    return _this.attributes.idp_uid;
  });
  ...
  (0, _defineProperty2.default)(this, "getProviderLabel", function () {
    return _this.attributes.provider_label;
  });
...
(0, _defineProperty2.default)(SsoEvent, "list", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee() {
  var _response$data;
  var params,
    options,
    response,
  ...
  return _regenerator.default.wrap(function (_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 2:
        _context.next = 3;
        return _Api.default.sendRequest('/sso_events', 'GET', params, options);
      case 3:
        response = _context.sent;
        return _context.abrupt("return", (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.map(function (obj) {
          return new _SsoEvent(obj, options);
        })) || []);
      case 4:
      case "end":
...
(0, _defineProperty2.default)(SsoEvent, "all", function () {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return _SsoEvent.list(params, options);
});
// Parameters:
//   id (required) - int64 - Sso Event ID.
(0, _defineProperty2.default)(SsoEvent, "find", /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2(id) {
    ...
    return _regenerator.default.wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.next = 4;
          return _Api.default.sendRequest("/sso_events/".concat(encodeURIComponent(params.id)), 'GET', params, options);
        case 4:
          response = _context2.sent;
          return _context2.abrupt("return", new _SsoEvent(response === null || response === void 0 ? void 0 : response.data, options));
        case 5:
        case "end":
...
(0, _defineProperty2.default)(SsoEvent, "get", function (id) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return _SsoEvent.find(id, params, options);
});
var _default = exports.default = SsoEvent;
